...
CHANNEL_MAX = np.array([178.4, 101.01, 84.633, 2.094, 2.316, 3.353, 0.63])*1.2
CHANNEL_MIN = np.array([-7.8787e+01, -4.4339e+01, -4.2628e+01, -2.2670e+00, -3.0220e+00, -3.2540e+00, -5.0000e-03])*1.2
...
class DCGAN():
    ...
    def save_imgs(self, epoch):
        ...
        sampled_labels = np.arange(30, 210, 18).reshape(-1, 1)
...
if __name__ == '__main__':
    ...
    if PREDICT:
        ...
        dcgan.train(epochs=180000+1, batch_size=16, save_interval=2000)
